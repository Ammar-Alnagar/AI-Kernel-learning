...
def kernel_hierarchical_layout(
    ...
    # TODO: Create layout with hierarchical_shape
    # For simplicity, use a flat stride and let CuTe handle the hierarchy
    # HINT: First, compute the flat shape: (4*32, 2*16) = (128, 32)
    #       Then create the hierarchical view
    
    # Alternative: Create directly with nested shape
    # You need to compute the proper stride for row-major at each level
