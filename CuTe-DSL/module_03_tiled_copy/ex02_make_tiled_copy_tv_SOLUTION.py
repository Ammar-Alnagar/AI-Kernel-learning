...
# Your answer: 32 threads × 32 elements = 1024 elements

# Q2: What is the difference between thread layout and value layout?
# Your answer: Thread layout partitions work across threads. Value layout
#              defines how many elements each thread processes.

# Q3: Why was make_tiled_copy deprecated in favor of make_tiled_copy_tv?
# Your answer: _tv makes the thread-value layout explicit, avoiding implicit
#              broadcast ambiguity. More consistent with value-partitioned model.
...
def kernel_tiled_copy_tv(
    ...
    dst_layout = cute.make_layout((TOTAL_ELEMENTS,), stride=(1,))
    ...
    if tid == 0:
        ...
        results[1] = 0.0  # Expected value
        results[2] = 100.0  # Expected dst[100]
        results[3] = 1023.0  # Expected dst[1023]
