...
int main() {
  ...
  auto layout_rm_4x4 =
      make_layout(make_shape(Int<4>{}, Int<4>{}), GenRowMajor{});
  auto layout_cm_4x4 =
      make_layout(make_shape(Int<4>{}, Int<4>{}), GenColMajor{});
  auto layout_rm_8x8 =
  ...
  std::cout << "  layout(0, 3) = 3" << std::endl;
  std::cout << "  layout(2, 1) = 9" << std::endl;
  std::cout << "  layout(3, 3) = 15" << std::endl;
  std::cout << std::endl;
  ...
  std::cout << "Your predictions:" << std::endl;
  std::cout << "  layout(3, 0) = 3" << std::endl;
  std::cout << "  layout(1, 2) = 9" << std::endl;
  std::cout << "  layout(3, 3) = 15" << std::endl;
  std::cout << std::endl;
  ...
  std::cout << "Your predictions:" << std::endl;
  std::cout << "  layout(0, 7) = 7" << std::endl;
  std::cout << "  layout(4, 3) = 35" << std::endl;
  std::cout << "  layout(7, 7) = 63" << std::endl;
  std::cout << std::endl;
  ...
  std::cout << "Your predictions:" << std::endl;
  std::cout << "  layout(0, 7) = 7" << std::endl;
  std::cout << "  layout(4, 3) = 39" << std::endl;
  std::cout << "  layout(7, 7) = 63" << std::endl;
  std::cout << std::endl;

  std::cout << "Actual values:" << std::endl;
  test_offset_prediction("Padded8x8", layout_padded, 0, 7, 7); // 0*9 + 7*1 = 7
  test_offset_prediction("Padded8x8", layout_padded, 4, 3,
                         39); // 4*9 + 3*1 = 39
  test_offset_prediction("Padded8x8", layout_padded, 7, 7,
                         70); // 7*9 + 7*1 = 70
  std::cout << std::endl;

  // FORMULA VERIFICATION
  std::cout << "=== Formula Verification ===" << std::endl;
  std::cout << "For row-major layout with shape (R, C) and stride (C, 1):"
            << std::endl;
  std::cout << "  offset(row, col) = row * C + col * 1" << std::endl;
  std::cout << std::endl;

  std::cout << "For column-major layout with shape (R, C) and stride (1, R):"
            << std::endl;
  std::cout << "  offset(row, col) = row * 1 + col * R" << std::endl;
  std::cout << std::endl;

  std::cout
      << "For padded layout with shape (R, C) and stride (P, 1) where P > C:"
      << std::endl;
  ...
  std::cout << "What is the stride? Answer: (5, 1) - This is a padded layout!"
            << std::endl;
  std::cout << std::endl;
